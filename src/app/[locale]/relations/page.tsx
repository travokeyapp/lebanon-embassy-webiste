...
const content = {
  ...
  ar: {
    ...
    intro:
      "يحافظ لبنان وباكستان على علاقات ثنائية ودية ترتكز على اتفاقات رسمية وتواصل دبلوماسي وتعاون عملي في عدة مجالات.",
    sections: [
      {
        ...
        paragraphs: [
          ...
          "وبحسب وزارة الخارجية الباكستانية، تعود العلاقات الثنائية إلى خمسينيات القرن الماضي مع وجود سفارتين مقيمتين في إسلام أباد وبيروت.",

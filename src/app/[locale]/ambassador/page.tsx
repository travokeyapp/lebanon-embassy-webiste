...
const content = {
  ...
  ar: {
    ...
    role: "سفير فوق العادة ومطلق الصلاحية للجمهورية اللبنانية لدى جمهورية باكستان الإسلامية",
    portraitLabel: "الصورة الرسمية",
    message: [
      "تعمل سفارة لبنان في إسلام أباد على خدمة المواطنين اللبنانيين وتعزيز التعاون الثنائي وترسيخ التواصل الإيجابي بين لبنان وباكستان.",

...
const newsCatalog: LocalizedNewsItem[] = enNews.map((enItem, index) => {
    const arItem = arNews[index];
    ...
    return {
        ...
        month: {
            en: enItem.month,
            ar: arItem?.month ?? enItem.month,
        },
        title: {
            en: enItem.title,
            ar: arItem?.title ?? enItem.title,
        },
        excerpt: {
            en: enItem.excerpt,
            ar: arItem?.excerpt ?? enItem.excerpt,
        },
    };
});
